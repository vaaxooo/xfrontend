<template>
    <div class="auth-card block p-32">
        <div class="auth-header">
            ...
            <p>Пожалуйста, заполните небольшую форму для создания новой учётной записи.</p>
        </div>
        ...
        <div class="auth-content">
            ...
            <div class="auth-form">
                ...
                <div class="field">
                    <input type="password" placeholder="Придумайте пароль" class="input">
                </div>
                ...
                <div class="auth-footer">
                    <span class="center justify-content-center">
                        Уже есть учётная запись? <a href="#" class="link link--primary">Войти в систему</a>
                    </span>
                </div>
