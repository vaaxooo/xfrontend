export default {
  ...
  security: {
    ...
    change_password_description: 'Enter your current password and set a new one to keep your account secure.',
    change_password_submit: 'Save new password',
    current_password: 'Current password',
    current_password_placeholder: 'Enter your current password',
    new_password: 'New password',
    new_password_placeholder: 'Create a new password',
    new_password_hint: 'At least 8 characters, combine letters and numbers.',
